...
def main():
    if len(sys.argv) != 8 or sys.argv[1] == "help" or sys.argv[1] != "Publish":
        print("How to use: ")
        print("  python3 eventwithhash.py Publish [dataprovider] [filepath] [filetype] [datatagkey] [datatagval] [previouseventid]")
